...
,p_default_workspace_id=>5510395883532103
,p_default_application_id=>12192
,p_default_owner=>'VMORNEAU'
);
end;
/
...
/
prompt --application/shared_components/plugins/region_type/apex_theme_documentation
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(48331325265042245)
,p_plugin_type=>'REGION TYPE'
,p_name=>'APEX.THEME.DOCUMENTATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48661326993800934)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'CSS Classes - table'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48663215200802962)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>2
,p_display_sequence=>20
,p_prompt=>'CSS Classes - thead'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48664900342805222)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>3
,p_display_sequence=>30
,p_prompt=>'CSS Classes - th'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48666620342806246)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>4
,p_display_sequence=>40
,p_prompt=>'CSS Classes - td'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48674566906815440)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'APPLICATION'
,p_attribute_sequence=>5
,p_display_sequence=>50
,p_prompt=>'Component Title CSS Classes'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48341348394061096)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(48341651160062772)
,p_plugin_attribute_id=>wwv_flow_api.id(48341348394061096)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(48342023505064603)
,p_plugin_attribute_id=>wwv_flow_api.id(48341348394061096)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(48342463460065580)
,p_plugin_attribute_id=>wwv_flow_api.id(48341348394061096)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(48342806928066270)
,p_plugin_attribute_id=>wwv_flow_api.id(48341348394061096)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(48343281087067006)
,p_plugin_attribute_id=>wwv_flow_api.id(48341348394061096)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(48343625742067812)
,p_plugin_attribute_id=>wwv_flow_api.id(48341348394061096)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48344015468136815)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
,p_prompt=>'Display Template Options'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(49021399275239162)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
,p_prompt=>'Display Only Associated Template Options'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(48344015468136815)
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48346050559188609)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
,p_prompt=>'Display All Template Option Group Choices'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'N'
,p_is_translatable=>false
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48346440485216111)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
,p_prompt=>'Display Grid Attributes'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'N'
,p_is_translatable=>false
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(48346760883236035)
,p_plugin_id=>wwv_flow_api.id(48331325265042245)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
,p_prompt=>'Display Custom Attributes'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'N'
,p_is_translatable=>false
,p_examples=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Buttons: button_template, image_name, image_attributes, button_css_classes, icon_css_classes, button_attributes, pre_element_text, post_element_text',
'',
'Items: display_as, placeholder, pre_element_text, post_element_text, format_mask, item_label_template, html_form_element_css_classes, html_form_element_attributes, form_element_option_attributes, item_button_image, item_button_image_attributes',
'',
'Regions & Reports: template, report_template, icon_css_classes, region_attributes_substitution, report_column_headings, pagination_scheme, pagination_display_position, breaks, fixed_header',
'',
'Lists: a01_label, a02_label, a03_label, a04_label, a05_label'))
,p_help_text=>'Pick YES to display all custom attributes related to your component.'
);
null;
end;
/
